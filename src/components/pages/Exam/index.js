                            ...
                            <div className="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                                <div className="datatable-top">
                                    ...
                                    <div className="datatable-dropdown">
                                        <Link to="/exam-create" className="btn btn-primary d-flex align-items-center justify-content-center">
                                            <i className="ti ti-plus"></i> Add new Exam
                                        </Link>
                                    </div>
                                </div>
                                    ...
                                    <table className="table table-hover datatable-table" id="pc-dt-simple">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-sortable="true">Exam Name</th>
                                            ...
                                            <tr data-index="0">
                                                ...
                                                <td className="text-center">
                                                    <ul className="list-inline me-auto mb-0">
                                                        ...
                                                        <Link to="/exam-edit" className="avtar avtar-xs btn-link-success btn-pc-default">
