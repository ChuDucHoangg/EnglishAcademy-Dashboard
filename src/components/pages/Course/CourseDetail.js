                            ...
                            <div className="tab-content" id="nav-tabContent">
                                <div className="tab-pane fade show active" id="list-mail-1" role="tabpanel" aria-labelledby="list-mailtab-1">
                                    <div className="table-card">
                                        ...
                                        <div className="card-body scroll-block mt-3">
                                                                ...
                                                                <div className="accordion-item" key={index}>
                                                                    ...
                                                                    >
                                                                        <div className="d-flex align-items-center justify-content-between my-3">
                                                                            <div>
                                                                                <Link to={`/course-online/topic-edit/${courseDetail.id}/${topic.slug}`} className="btn btn-icon btn-link-success">
                                                                            ...
                                                                            <Link to={`/course-online/item-create/${courseDetail.slug}`} className="btn btn-outline-primary d-flex align-items-center">
                                                                        ...
                                                                        {topic.itemOnlineDTOList.length === 0 ? (
                                                                            ...
                                                                            <ul className="list-group list-group-flush mb-3 border" style={{ borderRadius: 6 }}>
                                                                                                ...
                                                                                                <div className="row g-1">
                                                                                                    <div className="col-6">
                                                                                                        ...
                                                                                                        <p className="text-muted mb-0">
                                                                                                            <small>
                                                                                                                {(item.createdDate && format(new Date(item.createdDate), "dd-MM-yyyy")) || "N/A"}
                                                                                                            </small>
                                                                                                        </p>
                                                                                                    </div>
